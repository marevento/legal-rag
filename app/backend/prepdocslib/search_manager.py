...
class SearchManager:
    ...
    def __init__(
        ...
        api_key: str,
        index_name: str,
        semantic_config_name: str = "mietrecht-semantic",
    ...
    def create_or_update_index(self, use_semantic_ranker: bool = False) -> None:
                ...
                configurations=[
                    SemanticConfiguration(
                        ...
                        prioritized_fields=SemanticPrioritizedFields(
                            title_field=SemanticField(field_name="titel"),
                            content_fields=[SemanticField(field_name="content")],
                            keywords_fields=[SemanticField(field_name="paragraph")],
                        ),
                    )
                ]
            )
