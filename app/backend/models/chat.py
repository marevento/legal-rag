...
class ChatRequest(BaseModel):
    ...
    query_transform: Literal["none", "rewrite", "hyde"] = Field(
        default="none",
        description="none (raw query), rewrite (legal terminology), or hyde (hypothetical document embedding)",
    )
    decompose: bool = Field(default=False, description="Decompose multi-part questions into sub-queries")
